...
$tmp_dir			= dirname(__FILE__).'/calendars/cache';			// The temporary directory on your system (/tmp is fine for UNIXes including Mac OS X). Any php-writable folder works.
