...
$template 			= 'embed-new';		// Template support
$default_view 			= 'month';			// Default view for calendars = 'day', 'week', 'month', 'year'
$minical_view 			= 'current';		// Where do the mini-calendars go when clicked? = 'day', 'week', 'month', 'current'
$default_cal 			= 'milonga';		// Exact filename of calendar without .ics. Or set to $ALL_CALENDARS_COMBINED to open all calenders combined into one.
...
$day_start 			= '1200';			// Start time for day grid
$day_end			= '2300';			// End time for day grid
$gridLength 			= '30';		// Grid distance in minutes for day view, multiples of 15 preferred
$num_years 			= '1';				// Number of years (up and back) to display in 'Jump to'
$month_event_lines 		= '2';				// Number of lines to wrap each event title in month view, 0 means display all lines.
...
$timezone 				= 'Europe/Brussels';				// Set timezone. Read TIMEZONES file for more information
...
$bleed_time				= '0700';				// This allows events past midnight to just be displayed on the starting date, only good up to 24 hours. Range from '0000' to '2359', or '-1' for no bleed time.
...
$this_months_events 	= 'no';			// Display "This month's events" at the bottom off the month page.
...
$show_bottom		= 'no';			// Show your todo list on the side of day and week view.
...
$tmp_dir			= '/home/forret/apps/agenda.milonga.be/calendars/cache';			// The temporary directory on your system (/tmp is fine for UNIXes including Mac OS X). Any php-writable folder works.
$webcal_hours			= '1';				// Number of hours to cache webcals. Setting to '0' will always re-parse webcals.
...
$auth_internal_username	= 'Peter';	// Only used if $auth_method='internal'. The username for the administrator.
$auth_internal_password	= 'ppddsspp';	// Only used if $auth_method='internal'. The password for the administrator.
...
//$list_webcals[] = 'webcal://www.google.com/calendar/ical/85r6bg7tmis832th7cr843esfc%40group.calendar.google.com/public/basic.ics';						// Fill in between the quotes exact URL of a calendar that you wish
//$list_webcals[] = 'webcal://www.google.com/calendar/ical/28g96a9ll24jlhgu9tuhr90g98%40group.calendar.google.com/public/basic.ics';				// to show up in your calendar list. You must prefix the URL with http://
