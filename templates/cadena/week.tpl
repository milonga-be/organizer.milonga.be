				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="calborder">
					<tr>
						<td align="center" valign="middle">
							...
							<tr valign="top">
								<td align="left" width="490" class="title"><h1>{DISPLAY_DATE}</h1><span class="V9G">www.milonga.be - week view</span></td>
									...
									<td align="center" valign="top">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="1"></td>
												<!-- loop daysofweek on -->
												<td width="13%" {COLSPAN} align="center" class="{ROW1}" onmouseover="this.className='{ROW2}'" onmouseout="this.className='{ROW3}'" onclick="window.location.href='week.php?cal={CAL}&amp;getdate={DAYLINK}'">
											...
											<tr valign="top" id="allday">
												...
												<td width="13%" {COLSPAN} class="rowOff">
													<!-- loop allday on -->
