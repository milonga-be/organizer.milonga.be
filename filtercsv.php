...
if(isset($_GET['filter'])){
	...
	$page->draw_filter($page,$filterstring);
	}
else {
...
/*
$text=str_replace("CONCERT: ","ev:",$text);
$text=str_replace("MILONGA: ","mil:",$text);
$text=str_replace("PERFORMANCE: ","ev:",$text);
$text=str_replace("SALON: ","mil:",$text);
$text=str_replace("WORKSHOP: ","wrk:",$text);


$text=str_replace(Array("Brussels","Brussel","Bruxelles"),"BXL",$text);
$text=str_replace(Array("Brugge","Bruges"),"BRG",$text);
$text=str_replace(Array("Antwerpen","Antwerp","Anvers"),"ANT",$text);
$text=str_replace(Array("Wallonie","Wallonia"),"",$text);
