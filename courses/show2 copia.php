...
function school_header($code,$short=false){
	...
	if($short){
		...
		echo "<div style='margin-bottom:3px;'><a style='color:blue;text-decoration:none;border-bottom:1px dotted blue;' href='?code=$code' title='$name - $venue $addr'>$pc, $name @ $venue</a></div>\n";
		echo "<div style='margin-bottom:8px;font-size:0.9em;'>$addr</div>";
	} else {
